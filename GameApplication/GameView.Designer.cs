namespace GameApplication
{
	partial class GameView
	{
		...
		private void InitializeComponent()
		{
			...
			StatsButton.AutoSizeMode = AutoSizeMode.GrowAndShrink;
			StatsButton.Font = new Font("Segoe UI", 8F, FontStyle.Regular, GraphicsUnit.Point);
			StatsButton.Location = new Point(504, 20);
			StatsButton.Margin = new Padding(0);
			StatsButton.Name = "StatsButton";
			StatsButton.Size = new Size(186, 31);
			StatsButton.TabIndex = 17;
			StatsButton.Text = "View Database Statistics";
